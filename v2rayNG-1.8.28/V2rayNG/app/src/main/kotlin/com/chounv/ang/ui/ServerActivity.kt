...
import com.chounv.ang.AppConfig
import com.chounv.ang.AppConfig.PREF_ALLOW_INSECURE
import com.chounv.ang.AppConfig.WIREGUARD_LOCAL_ADDRESS_V4
import com.chounv.ang.AppConfig.WIREGUARD_LOCAL_ADDRESS_V6
import com.chounv.ang.AppConfig.WIREGUARD_LOCAL_MTU
import com.chounv.ang.R
import com.chounv.ang.dto.EConfigType
import com.chounv.ang.dto.ServerConfig
import com.chounv.ang.dto.V2rayConfig
import com.chounv.ang.dto.V2rayConfig.Companion.DEFAULT_PORT
import com.chounv.ang.dto.V2rayConfig.Companion.TLS
import com.chounv.ang.extension.removeWhiteSpace
import com.chounv.ang.extension.toast
import com.chounv.ang.util.MmkvManager
import com.chounv.ang.util.MmkvManager.ID_MAIN
import com.chounv.ang.util.MmkvManager.KEY_SELECTED_SERVER
import com.chounv.ang.util.Utils
import com.chounv.ang.util.Utils.getIpv6Address
